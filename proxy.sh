...
function run_proxy_server() {
  echo "Starting run_proxy_server function" >> $script_log_fil
  ...
  $bash_location $startup_script_path >> $script_log_file 2>&1
  echo "Startup script finished with exit code $?" >> $script_log_file
